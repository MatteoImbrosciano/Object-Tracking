...
video_path = "C:\\Users\\matte\\OneDrive\\Desktop\\Multimedia\\progetto\\bdd100k\\00c4c672-26d36ad8.mp4"

# Imposta il percorso per il video di output con gli oggetti tracciati
tracked_video_path = "tracked_video_1.mp4"
video_writer = None
...
try:
    while True:
        ...
        cv2.putText(frame, f'Total cars detected: {total_cars_detected}', (20, 75), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
...
df_tracked.to_csv('tracked_results_1.csv', index=False)
