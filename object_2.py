...
video_path = "C:\\Users\\matte\\OneDrive\\Desktop\\Multimedia\\prog\\bdd100k\\00c17a92-d4803287.mp4"

# Imposta il percorso per il video di output con gli oggetti tracciati
tracked_video_path = "tracked_video_2.mp4"
video_writer = None
...
df_tracked.to_csv('tracked_results_2.csv', index=False)
